...
if($_GET['acao'] == 'cadastrar'){
    ...
    if(mysql_query($sql_insert)){
        echo "<script>location.href = '?secao=niveis_editar&id=".mysql_insert_id()."&cadastrado=1';</script>";
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <form role="form" id="form" action="?secao=niveis_cadastrar&acao=cadastrar" method="post"  enctype="multipart/form-data">
                <div class="col-md-12">
