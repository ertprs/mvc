...
if($_GET['acao'] == 'cadastrar'){
    ...
    if(mysql_query($sql_insert)){
        echo "<script>location.href = '?secao=produtos_categorias_editar&id=".mysql_insert_id()."&cadastrado=1';</script>";
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <form role="form" id="form" action="?secao=produtos_categorias_cadastrar&acao=cadastrar" method="post" enctype="multipart/form-data">
                <div class="col-md-12">
